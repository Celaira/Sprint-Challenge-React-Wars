...
A library, or framework that Facebook created to handle data that changes over time, as well as optimization of that data.

- [x] What does it mean to _think_ in react?

Breaking data, and pages down into their smallest parts to modulate the development process.

- [x] Describe state.

State is an immutable--unless specified by the use of `this.setState()`--storage object. It is what holds the data for your React application.

- [x] Describe props.

Variables or properties that are attached to a React component. They are immutable once they are created, and are used to pass data between other components.
